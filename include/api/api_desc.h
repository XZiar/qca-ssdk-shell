...
#define SW_API_FDB_AGE_MODE_GET_DESC \
    ...
    SW_PARAM_DEF(SW_API_FDB_AGE_MODE_GET, SW_FDB_CTRL_MODE, 4, SW_PARAM_PTR|SW_PARAM_OUT, "Age Mode"),
...
#define SW_API_FDB_LEARN_MODE_GET_DESC \
    ...
    SW_PARAM_DEF(SW_API_FDB_LEARN_MODE_GET, SW_FDB_CTRL_MODE, 4, SW_PARAM_PTR|SW_PARAM_OUT, "Learn Mode"),
...
#define SW_API_RFDB_PROFILE_GET_DESC \
    ...
    SW_PARAM_DEF(SW_API_RFDB_PROFILE_GET, SW_MACADDR, sizeof(fal_mac_addr_t), SW_PARAM_PTR|SW_PARAM_OUT, "Address"),\
