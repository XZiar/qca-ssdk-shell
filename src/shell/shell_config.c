...
struct cmd_des_t gcmd_des[] =
{
	...
	{"vsiarpsg", "set", "set vsi arp sg", "", SW_API_IP_VIS_ARP_SG_CFG_SET, NULL},
	      ...
	      {"networkroute", "add", "add network route", "", SW_API_IP_NETWORK_ROUTE_ADD, NULL},
		...
		{"pubip", "set", "set pub ip", "", SW_API_IP_PUB_IP_SET, NULL},
		{"networkroute", "del", "del network route", "", SW_API_IP_NETWORK_ROUTE_DEL, NULL},
