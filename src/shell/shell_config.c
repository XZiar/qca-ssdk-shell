...
/*qca808x_end*/
...
#ifdef IN_TUNNEL
	{
		"tunnel", "config tunnel",
		{
			...
			{"decap_header_ctrl", "set", "set global decap header control of tunnel",
				"<decap_header_ctrl>", SW_API_TUNNEL_DECAP_HEADER_CTRL_SET, NULL},
			{"decap_header_ctrl", "get", "get global decap header control of tunnel",
				"", SW_API_TUNNEL_DECAP_HEADER_CTRL_GET, NULL},
			{NULL, NULL, NULL, NULL, SW_API_INVALID, NULL}/*end of desc*/
		},
	},
#endif
