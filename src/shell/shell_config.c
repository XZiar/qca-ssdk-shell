...
struct cmd_des_t gcmd_des[] =
{
...
#ifdef IN_PORTVLAN
    {
        "portVlan", "config port base VLAN",
        {
            ...
            {"ptIngressfilter", "set", "set port ingress filter", "<port_id>", SW_API_PT_INGRESS_VLAN_FILTER_SET, NULL},
            {"ptIngressfilter", "get", "get port ingress filter", "<port_id>", SW_API_PT_INGRESS_VLAN_FILTER_GET, NULL},
            {"ptdefaultvlantag", "set", "set port default vlan tag", "<port_id> <all|ingress|egress>", SW_API_PT_DEFAULT_VLANTAG_SET, NULL},
            {"ptdefaultvlantag", "get", "get port default vlan tag", "<port_id> <all|ingress|egress>", SW_API_PT_DEFAULT_VLANTAG_GET, NULL},
            {"pttagprop", "set", "set port tag propagation", "<port_id> <all|ingress|egress>", SW_API_PT_TAG_PROPAGATION_SET, NULL},
            {"pttagprop", "get", "get port tag propagation", "<port_id> <all|ingress|egress>", SW_API_PT_TAG_PROPAGATION_GET, NULL},
            {"ptegmode", "set", "set port egress vlan mode", "<port_id>", SW_API_PT_VLANTAG_EGMODE_SET, NULL},
            {"ptegmode", "get", "get port egress vlan mode", "<port_id>", SW_API_PT_VLANTAG_EGMODE_GET, NULL},
            ...
            {"ptvsiegmode", "set", "set a vsi port egress tag", "<vsi> <port_id> <untagged/tagged/unmodified/untouched>", SW_API_PT_VSI_EGMODE_SET, NULL},
...
#ifdef IN_FDB
    {
        "fdb", "config FDB table",
        {
            ...
            {"ptNewAddrLearn", "set", "set new address learning and forward", "<port_id> <enable|disable> <forward|drop|cpycpu|rdtcpu>", SW_API_FDB_PT_NEWADDR_LEARN_SET, NULL},
            {"ptNewAddrLearn", "get", "get new address learning and forward", "<port_id>", SW_API_FDB_PT_NEWADDR_LEARN_GET, NULL},
            ...
            {"ageMode", "set", "set FDB entry aging control mode", "<0:auto mode|1:control mode>", SW_API_FDB_AGE_MODE_SET, NULL},
            {"ageMode", "get", "get FDB entry aging control mode", "", SW_API_FDB_AGE_MODE_GET, NULL},
            ...
            {"learnMode", "set", "set FDB entry learn control mode", "<0:auto mode|1:control mode>", SW_API_FDB_LEARN_MODE_SET, NULL},
            {"learnMode", "get", "get FDB entry learn control mode", "", SW_API_FDB_LEARN_MODE_GET, NULL},
	...
	{"ptPri", "set", "set port priority", "<port_id> <priority>", SW_API_QOS_PORT_PRI_SET, NULL},
	{"ptPri", "get", "get port priority", "<port_id>", SW_API_QOS_PORT_PRI_GET, NULL},
 ...
 /* FLOW */
...
#ifdef IN_VSI
    {
        "vsi", "config vsi",
        {
            ...
            {"vlan_vsi", "set", "Set vlan vsi", "<port_id> <stag_vid> <ctag_vid> <vsi>", SW_API_PORT_VLAN_VSI_SET, NULL},
            {"vlan_vsi", "get", "Get vlan vsi", "<port_id> <stag_vid> <ctag_vid>", SW_API_PORT_VLAN_VSI_GET, NULL},
...
#ifdef IN_QM
    {
        "qm", "config qm",
        {
	    {"ucastqbase", "set", "set unicast queue base and profile", "", SW_API_UCAST_QUEUE_BASE_PROFILE_SET, NULL},
	    {"ucastqbase", "get", "get unicast queue base and profile", "", SW_API_UCAST_QUEUE_BASE_PROFILE_GET, NULL},
	    {"ucastpriclass", "set", "set unicast pri class", "", SW_API_UCAST_PRIORITY_CLASS_SET, NULL},
	    {"ucastpriclass", "get", "get unicast pri class", "", SW_API_UCAST_PRIORITY_CLASS_GET, NULL},
	    {"mcastpriclass", "set", "set mcast pri class", "", SW_API_MCAST_PRIORITY_CLASS_SET, NULL},
	    {"mcastpriclass", "get", "get mcast pri class", "", SW_API_MCAST_PRIORITY_CLASS_GET, NULL},
	    ...
	    {"mcastcpucode", "set", "set mcast cpucode map", "", SW_API_MCAST_CPUCODE_CLASS_SET, NULL},
	    {"mcastcpucode", "get", "get mcast cpucode map", "", SW_API_MCAST_CPUCODE_CLASS_GET, NULL},
	    {"acctrl", "set", "set ac ctrl", "", SW_API_AC_CTRL_SET, NULL},
	    {"acctrl", "get", "get ac ctrl", "", SW_API_AC_CTRL_GET, NULL},
	    {"acprebuffer", "set", "set ac prealloc", "", SW_API_AC_PRE_BUFFER_SET, NULL},
	    {"acprebuffer", "get", "get ac prealloc", "", SW_API_AC_PRE_BUFFER_GET, NULL},
	    {"acqgroup", "set", "set ac queue group", "", SW_API_QUEUE_GROUP_SET, NULL},
	    {"acqgroup", "get", "get ac queue group", "", SW_API_QUEUE_GROUP_GET, NULL},
	    {"acsthresh", "set", "set ac static thresh", "", SW_API_STATIC_THRESH_SET, NULL},
	    {"acsthresh", "get", "get ac static thresh", "", SW_API_STATIC_THRESH_GET, NULL},
	    {"acdthresh", "set", "set ac dynamic thresh", "", SW_API_DYNAMIC_THRESH_SET, NULL},
