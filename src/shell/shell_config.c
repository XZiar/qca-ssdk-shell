...
/*qca808x_end*/
...
#ifdef IN_SEC
    {
        "sec", "config security",
        {
            ...
            {"tunnlel3parser", "set", "set tunnel l3 parser ctrl", "<ttl> <hop>", SW_API_SEC_TUNNEL_L3_PARSER_CTRL_SET, NULL},
            {"tunnlel3parser", "get", "get tunnel l3 parser ctrl", "<ttl> <hop>", SW_API_SEC_TUNNEL_L3_PARSER_CTRL_GET, NULL},
            {"tunnlel4parser", "set", "set tunnel l4 parser ctrl", "<tcp_flag> <tcp_flag_mask>", SW_API_SEC_TUNNEL_L4_PARSER_CTRL_SET, NULL},
            {"tunnlel4parser", "get", "get tunnel l4 parser ctrl", "<tcp_flag> <tcp_flag_mask>", SW_API_SEC_TUNNEL_L4_PARSER_CTRL_GET, NULL},
            {"tunnleflagsparser", "set", "set tunnel header flags parser ctrl", "<entry_index:0~15> <entry_valid> <comp_mode> <tunnel_hdr_type> <flags> <mask>", SW_API_SEC_TUNNEL_FLAGS_PARSER_CTRL_SET, NULL},
            {"tunnleflagsparser", "get", "get tunnel header flags parser ctrl", "<entry_index>", SW_API_SEC_TUNNEL_FLAGS_PARSER_CTRL_GET, NULL},
            {NULL, NULL, NULL, NULL, SW_API_INVALID, NULL}/*end of desc*/
        },
    },
#endif
