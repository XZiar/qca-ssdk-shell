...
/*qca808x_end*/
            ...
            {"congedrop", "get", "get congestion drop of port queue",
                ...
                "<ring_id:0-7 for port0, 8-15 for port5> <on_thres> <off_thres>", SW_API_PT_RING_FLOW_CTRL_THRES_SET,
                NULL},
            {"ringfcthres", "get", "get ring flow ctrl of ring", "<ring_id:0-7 for port0, 8-15 for port5>",
